...
def predict(img_path, knn_clf=None, model_path=None, threshold=0.4): # 6 needs 40+ accuracy, 4 needs 60+ accuracy
    ...
    # acc = [100 -closest_distances[0][i][0] *100 for i in range(len(face_box))]
...
while True:
    ...
    for name, (top, right, bottom, left) in predictions:
        ...
        # cv2.putText(frame, fps, (16,40), font,  (0, 0, 0), 1)
